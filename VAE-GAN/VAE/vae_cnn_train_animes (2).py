...
img_list = os.listdir('/content/animefacedataset')
...
anime_data = datasets.ImageFolder('/content/animefacedataset', transform = transform)
...
torch.save(model.state_dict(), '/content/animesCnnVae.torch')